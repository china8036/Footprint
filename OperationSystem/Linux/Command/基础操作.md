- [Base Operation](#base-operation)
  ...
  - [11. 搜索](#11-搜索)
    - [11.1. 文件搜索](#111-文件搜索)
      - [11.1.1. locate](#1111-locate)
      - [11.1.2. find](#1112-find)
    - [11.2. 命令（二进制文件）搜索](#112-命令二进制文件搜索)
      - [11.2.1. whereis](#1121-whereis)
      - [11.2.2. which](#1122-which)
  - [12. 字符串搜索：grep](#12-字符串搜索grep)
  - [13. 权限控制](#13-权限控制)
    - [13.1. 基础概念](#131-基础概念)
      - [13.1.1. 权限类型](#1311-权限类型)
        - [13.1.1.1. 基本权限类型](#13111-基本权限类型)
        - [13.1.1.2. 附加权限类型](#13112-附加权限类型)
      - [13.1.2. 权限粒度](#1312-权限粒度)
      - [13.1.3. 权限表示](#1313-权限表示)
    - [13.2. chmod](#132-chmod)
