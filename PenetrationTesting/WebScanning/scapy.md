...
* [Scapy](#scapy)
  ...
  * [数据嗅探与过滤](#数据嗅探与过滤)
    * [sniff()](#sniff)
    * [filter](#filter)
    * [sniff HTTP Package](#sniff-http-package)
  * [Scanning](#scanning)
    * [ping](#ping)
  ...
  * [Classic Attrack Achieve](#classic-attrack-achieve)
    * [Maiformed packets](#maiformed-packets)
    * [Ping of Death](#ping-of-death)
    * [Nestea attack](#nestea-attack)
...
SYN Flood Attack / SYNDdos Attack / SYN 泛洪攻击是一种比较常用的DdoS方式之一，通过发送大量伪造的Tcp连接请求，使被攻击主机资源耗尽(通常是CPU满负荷或者内存不足) 的攻击方式；
