...
e.g. 对于 8086CPU，当 CPU 内部有以下情况发生的时候，将产生相应的内中断信息：
...
e.g. 对于 8086CPU，在执行完向 ss 寄存器传送数据的指令后，即便是发生中断，CPU 也不会响应。这是因为，ss:sp 联合指向栈顶，若 ss 改变而 sp 并未改变，将导致 ss:sp 指向错误的地址而引发错误。
