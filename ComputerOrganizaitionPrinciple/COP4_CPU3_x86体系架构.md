...
i.e. 现今大部分的 x86 操作系统都在保护模式下运行，如 Linux、FreeBSD、Windows (>2.0)。
...
通过这些措施，8086 程序既可以正常地运行下去，且中间的判断过程对 8086 程序是完全透明的。i.e. MS-DOS 应用程序在 Windows 操作系统中就是这样工作的。
