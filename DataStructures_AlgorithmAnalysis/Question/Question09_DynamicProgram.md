- [Dynamic programming](#dynamic-programming)
  ...
  - [9. 矩阵系列问题](#9-矩阵系列问题)
    - [9.1. 矩阵内的不同路径](#91-矩阵内的不同路径)
      - [9.1.1. Unique Paths](#911-unique-paths)
      - [9.1.2. Unique Paths II](#912-unique-paths-ii)
    - [9.2. 直方图内的最大覆盖矩阵](#92-直方图内的最大覆盖矩阵)
    - [9.3. 矩阵内的最大全一长方形](#93-矩阵内的最大全一长方形)
    - [9.4. 矩阵内的最大全一正方形](#94-矩阵内的最大全一正方形)
    - [9.5. 矩阵内的最大加号](#95-矩阵内的最大加号)
    - [9.6. 矩阵内的最大和](#96-矩阵内的最大和)
  - [10. 其它](#10-其它)
    - [10.1. 字母交换](#101-字母交换)
    - [10.2. 跳房子](#102-跳房子)
...
- Solution
  ...
  - 辅助栈：实际上可以把这道题看作是 [84. Largest Rectangle in Histogram](https://leetcode.com/problems/largest-rectangle-in-histogram/) 的扩展，对每一行，把它上面的所有行往下做投影，即依次把每一行都当成一个柱形图的底，然后就可以直接采用 85 题的思路了。
    ...
    ![image](http://img.cdn.firejq.com/jpg/2018/10/31/c9900526ed084a592910b22061c33be4.jpg)
