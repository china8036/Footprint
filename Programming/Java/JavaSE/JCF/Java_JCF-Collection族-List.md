- [Java 集合：Collection 族 - List](#java-collection----list)
    - [1. List 接口](#1-list)
        - [1.1. 基本概念](#11)
        - [1.2. 常用 API](#12--api)
        - [1.3. 专用迭代器：ListIterator](#13-listiterator)
            - [1.3.1. 基本概念](#131)
            - [1.3.2. 常用 API](#132--api)
    ...
    - [3. Vector](#3-vector)
    - [4. Stack](#4-stack)
    - [5. AbstractSequentialList 抽象类](#5-abstractsequentiallist)
    ...
    - [7. Interview FAQ](#7-interview-faq)
        - [7.1. 关于 ArrayList](#71--arraylist)
            - [7.1.1. ArrayList 的大小是如何自动增加的？](#711-arraylist)
            - [7.1.2. 如何复制某个 ArrayList 到另一个 ArrayList 中去？写出你的代码？](#712--arraylist--arraylist)
            - [7.1.3. 说一下 ArrayList 在循环遍历中删除元素的陷阱？](#713--arraylist)
            - [7.1.4. 手写 ArrayList 的简易实现](#714--arraylist)
        - [7.2. 关于 LinkedList](#72--linkedlist)
        - [7.3. 关于 ArrayList 与 LinkedList 的关系](#73--arraylist--linkedlist)
            - [7.3.1. ArrayList 与 LinkedList 的异同？](#731-arraylist--linkedlist)
            - [7.3.2. 什么情况下你会使用 ArrayList？什么时候你会选择 LinkedList？](#732--arraylist-linkedlist)
            - [7.3.3. 如果不考虑任何性能问题，能否将所有 ArrayList 都替换为 LinkedList？](#733--arraylist--linkedlist)
