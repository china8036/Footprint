- [数据结构：树结构 - 二叉树](#)
  ...
  - [3. 基本操作](#3)
    - [3.1. 根据序列重建二叉树](#31)
      - [3.1.1. 概念说明](#311)
      - [3.1.2. 根据先序拓展序列创建二叉树（递归实现）](#312)
      - [3.1.3. 根据先序 + 中序 || 后序 + 中序 || 层序 + 中序 序列创建二叉树（递归实现）](#313)
      - [3.1.4. 根据层序遍历序列创建二叉树（非递归实现）](#314)
    - [3.2. 二叉树的遍历](#32)
      - [3.2.1. DFS（利用栈）](#321-dfs)
        - [3.2.1.1. 先序遍历（DLR）](#3211-dlr)
        - [3.2.1.2. 中序遍历（LDR）](#3212-ldr)
        - [3.2.1.3. 后序遍历（LRD）](#3213-lrd)
      - [3.2.2. BFS：层序遍历（利用队列）](#322-bfs)
    - [3.3. 二叉树与森林的转换](#33)
      - [3.3.1. 森林转换为二叉树](#331)
      - [3.3.2. 二叉树转换成森林](#332)
    - [3.4. 求二叉树的深度](#34)
    - [3.5. 判断二叉树是否为完全二叉树](#35)
    - [3.6. 求二叉树的叶子总数](#36)
    - [3.7. 遍历所有叶子结点](#37)
    - [3.8. 为二叉树复制一份副本](#38)
    - [3.9. 判断两棵树是否相等](#39)
    - [3.10. 求每层的节点数，保存在数组中](#310)
    - [3.11. 求二叉树第 K 层的节点数和二叉树第 K 层的叶子节点数，递归方式和非递归方式](#311--k--k)
    - [3.12. 打印二叉树中第 K 层的第 M 个节点，非递归算法](#312--k--m)
    - [3.13. 比较两个二叉树是否相同（结构和数据），递归和非递归](#313)
    - [3.14. 求二叉树的镜像，递归和非递归方式](#314)
    - [3.15. 查找两个节点的最近公共祖先（LCA 问题）](#315-lca)
    - [3.16. 求二叉树中任意两个节点之间的距离，递归和非递归](#316)
    - [3.17. 其他操作](#317)
