- [数据结构：树结构 - 堆](#)
    ...
    - [2. 二叉堆](#2)
        ...
        - [2.2. 时间效率](#22)
        - [2.3. 基本操作](#23)
            - [2.3.1. 向上调整 (Shift Up)](#231--shift-up)
            - [2.3.2. 插入节点](#232)
            - [2.3.3. 向下调整 (Shift Down)](#233--shift-down)
            - [2.3.4. 删除节点](#234)
            - [2.3.5. 堆化](#235)
        - [2.4. 示例：实现一个最大堆](#24)
        - [2.5. 应用](#25)
            - [2.5.1. 堆排序 （Heap Sort）](#251--heap-sort)
            - [2.5.2. 事件模拟的优先队列](#252)
            - [2.5.3. 大数据的 top-K 问题](#253--top-k)
            - [2.5.4. 多路归并排序](#254)
    - [3. 索引堆](#3)
        - [3.1. 针对修改元素的优化：引入反向查找数组](#31)
    - [4. 二项堆](#4)
    - [5. 斐波那契堆](#5)
...
性质：
- 任意节点总是小于（或大于）它的所有后裔。
- **堆是一棵完全树**。即除了最底层，其他层的节点都被元素填满，且最底层尽可能地从左到右填入。
