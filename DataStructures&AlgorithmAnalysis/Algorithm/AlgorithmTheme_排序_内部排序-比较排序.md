- [内部排序 - 比较排序](#)
	- [1. 插入排序](#1)
		- [1.1. 直接插入排序 (Straight insertion Sort)](#11--straight-insertion-sort)
		- [1.2. 希尔排序 (Shell Sort)](#12--shell-sort)
	- [2. 选择排序](#2)
		- [2.1. 直接选择排序 （Straight Selection Sort）](#21--straight-selection-sort)
		- [2.2. 堆排序 (Heap Sort)](#22--heap-sort)
			- [2.2.1. 建堆优化](#221)
			- [2.2.2. 空间优化：原地堆排序](#222)
	- [3. 交换排序](#3)
		- [3.1. 冒泡排序 (Bubble Sort)](#31--bubble-sort)
		- [3.2. 快速排序 (Quick Sort)](#32--quick-sort)
			- [3.2.1. 针对短序列的优化：直接使用插入排序](#321)
			- [3.2.2. 针对基本有序序列的优化：随机化基准](#322)
			- [3.2.3. 针对重复元素的优化：二路快排和三路快排](#323)
				- [3.2.3.1. 二路快排](#3231)
				- [3.2.3.2. 三路快排](#3232)
			- [3.2.4. 算法思想扩展](#324)
	- [4. （两路）归并排序 (Merge Sort)](#4--merge-sort)
		- [4.1. 针对短序列优化：直接使用插入排序](#41)
		- [4.2. 针对基本有序序列优化：提前终止](#42)
		- [4.3. 自顶向下与自底向上的比较](#43)
		- [4.4. 算法思想扩展](#44)
	- [5. 综合比较](#5)
		- [5.1. 性能测试](#51)
