- [算法设计方法：动态规划](#)
	...
	- [3. 求解步骤](#3)
		...
		- [3.3. 最优决策表](#33)
	- [4. 应用](#4)
		- [4.1. 斐波那契数列 Fibonacci polynomial](#41--fibonacci-polynomial)
			- [4.1.1. 爬楼梯问题 Climbing Stairs](#411--climbing-stairs)
			- [4.1.2. Triangle](#412-triangle)
			- [4.1.3. Minimum Path Sum](#413-minimum-path-sum)
		- [4.2. 整数分解](#42)
			- [4.2.1. Integer Break](#421-integer-break)
			- [4.2.2. Perfect Squares](#422-perfect-squares)
			- [4.2.3. Decode Ways](#423-decode-ways)
			- [4.2.4. Unique Paths](#424-unique-paths)
			- [4.2.5. Unique Paths II](#425-unique-paths-ii)
		- [4.3. 抢劫房子问题](#43)
			- [4.3.1. House Robber](#431-house-robber)
			- [4.3.2. House Robber II](#432-house-robber-ii)
			- [4.3.3. House Robber III](#433-house-robber-iii)
			- [4.3.4. Best Time to Buy and Sell Stock with Cooldown](#434-best-time-to-buy-and-sell-stock-with-cooldown)
		- [4.4. 背包问题](#44)
			- [4.4.1. Partition Equal Subset Sum](#441-partition-equal-subset-sum)
			- [4.4.2. Coin Change](#442-coin-change)
			- [4.4.3. Combination Sum IV](#443-combination-sum-iv)
			- [4.4.4. Ones and Zeroes](#444-ones-and-zeroes)
			- [4.4.5. Word Break](#445-word-break)
			- [4.4.6. Target Sum](#446-target-sum)
		- [4.5. 最长上升子序列 （LIS 问题）](#45--lis)
			- [4.5.1. Longest Increasing Subsequence](#451-longest-increasing-subsequence)
			- [4.5.2. Wiggle Subsequence](#452-wiggle-subsequence)
		- [4.6. 最长公共子序列（LCS 问题）](#46-lcs)
		- [4.7. Dijkstra 最短路径算法](#47-dijkstra)
		- [4.8. 图像压缩](#48)
		- [4.9. 矩阵连乘法](#49)
...
- 最优化原理：如果**问题的最优解所包含的子问题的解也是最优的**，就称该问题具有**最优子结构**，即满足最优化原理。
...
### 4.1. 斐波那契数列 Fibonacci polynomial
...
#### 4.3.2. House Robber II

[213. House Robber II](https://leetcode.com/problems/house-robber-ii/description/)

#### 4.3.3. House Robber III

[Ho337. House Robber III](https://leetcode.com/problems/house-robber-iii/description/)

#### 4.3.4. Best Time to Buy and Sell Stock with Cooldown
...
#### 4.4.1. Partition Equal Subset Sum
...
#### 4.4.3. Combination Sum IV

[377. Combination Sum IV](https://leetcode.com/problems/combination-sum-iv/description/)

#### 4.4.4. Ones and Zeroes
...
#### 4.5.1. Longest Increasing Subsequence
